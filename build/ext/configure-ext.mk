...
MINIRUBY = /usr/bin/ruby --disable=gems -I. -raarch64-freebsd-fake 
SCRIPT_ARGS = --dest-dir="/morello-hybrid/src/output/rootfs-aarch64/.rubies/ruby-master" --extout=".ext" --ext-build-dir="./ext" --mflags="" --make-flags=""
